...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lhlu;->c:Z

    sput-boolean v1, Lhlu;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lhlu;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lhlu;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lhlu;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    .line 2
    sget-object v3, Lhlu;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lhob;->a(Landroid/content/Context;)I
    ...
    .line 4
    sget-object v3, Lhqx;->a:Ljava/lang/Boolean;
    ...
    sput-object v3, Lhqx;->a:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lhlv;->a(Landroid/content/Context;)Lhlv;

    if-eqz v4, :cond_6

    sget-object v4, Lhom;->a:[Lhoj;

    invoke-static {v3, v4}, Lhlv;->a(Landroid/content/pm/PackageInfo;[Lhoj;)Lhoj;
    ...
    :cond_5
    new-array v4, v1, [Lhoj;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Lhlv;->a(Landroid/content/pm/PackageInfo;[Lhoj;)Lhoj;
    ...
    :cond_6
    sget-object v3, Lhom;->a:[Lhoj;

    invoke-static {v6, v3}, Lhlv;->a(Landroid/content/pm/PackageInfo;[Lhoj;)Lhoj;
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v4}, Lhrj;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array v3, v3, [Lhoj;

    const/4 v4, 0x0

    sget-object v5, Lhom;->a:[Lhoj;
    ...
    invoke-static {v2, v3}, Lhlv;->a(Landroid/content/pm/PackageInfo;[Lhoj;)Lhoj;
