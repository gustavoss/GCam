...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lhnq;->a:Ljava/util/HashMap;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lhnq;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lhnq;->c:Landroid/os/Handler;

    invoke-static {}, Lhoc;->a()Lhoc;

    move-result-object v0

    iput-object v0, p0, Lhnq;->d:Lhoc;
...
.method static synthetic a(Lhnq;)Ljava/util/HashMap;
    .locals 1

    iget-object v0, p0, Lhnq;->a:Ljava/util/HashMap;

    return-object v0
.end method

.method static synthetic b(Lhnq;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Lhnq;->c:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic c(Lhnq;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lhnq;->b:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic d(Lhnq;)Lhoc;
    .locals 1

    iget-object v0, p0, Lhnq;->d:Lhoc;

    return-object v0
.end method

.method static synthetic e(Lhnq;)J
    .locals 2

    iget-wide v0, p0, Lhnq;->f:J
...
.method protected final b(Lhnp;Landroid/content/ServiceConnection;)V
    ...
    iget-object v2, v0, Lhnr;->a:Ljava/util/Set;
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    :pswitch_1
    iget-object v4, p0, Lhnq;->a:Ljava/util/HashMap;
    ...
    :goto_1
    invoke-virtual {v1, v0}, Lhnr;->onServiceDisconnected(Landroid/content/ComponentName;)V
