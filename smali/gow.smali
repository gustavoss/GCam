...
.method constructor <init>(Landroid/os/storage/StorageManager;Linb;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgow;->b:Landroid/os/storage/StorageManager;

    iput-object p2, p0, Lgow;->c:Linb;
...
# virtual methods
.method public final a(Lgns;)J
    .locals 5

    :try_start_0
    iget-object v0, p0, Lgow;->c:Linb;

    iget-boolean v0, v0, Linb;->c:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lgow;->b:Landroid/os/storage/StorageManager;

    invoke-interface {p1}, Lgns;->a()Ljava/io/File;
    ...
    iget-object v1, p0, Lgow;->b:Landroid/os/storage/StorageManager;
