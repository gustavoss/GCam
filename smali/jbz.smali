...
.method public constructor <init>(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Ljava/io/Writer;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Ljbz;->c:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    iput-object p2, p0, Ljbz;->a:Ljava/io/Writer;

    iput-object p3, p0, Ljbz;->b:Ljava/util/concurrent/Executor;
...
.method public final getAssignmentCount(Ljpu;)I
    ...
    iget-object v0, p0, Ljbz;->c:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    invoke-interface {v0, p1}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getAssignmentCount(Ljpu;)I
...
.method public final getFeature(JLjpu;)Lcom/google/android/libraries/smartburst/utils/Feature;
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getFeature(JLjpu;)Lcom/google/android/libraries/smartburst/utils/Feature;
...
.method public final getRowIterator(J)Ljbv;
    ...
    invoke-interface {v0, p1, p2}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Ljbv;
...
.method public final setFeatureValue(JLcom/google/android/libraries/smartburst/utils/Feature;)Z
    ...
    iget-object v1, p0, Ljbz;->b:Ljava/util/concurrent/Executor;

    new-instance v2, Ljca;

    invoke-direct {v2, p0, p1, p2, p3}, Ljca;-><init>(Ljbz;JLcom/google/android/libraries/smartburst/utils/Feature;)V
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Ljbz;->c:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
