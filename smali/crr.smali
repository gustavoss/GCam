...
.method public constructor <init>(Lfea;)V
    ...
    iput-object v0, p0, Lcrr;->a:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcrr;->f:Landroid/graphics/Rect;

    iget-object v0, p0, Lcrr;->f:Landroid/graphics/Rect;

    iget-object v1, p0, Lcrr;->f:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->bottom:I

    iget-object v2, p0, Lcrr;->f:Landroid/graphics/Rect;
...
.method private final declared-synchronized a(Linu;)V
    .locals 5
    ...
    iget-object v1, p0, Lcrr;->a:Ljava/lang/Object;
    ...
    :try_start_1
    iget-boolean v2, p0, Lcrr;->e:Z

    if-eqz v2, :cond_1

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcrr;->e:Z

    :cond_0
    :goto_0
    iput-object p1, p0, Lcrr;->c:Linu;

    iput-object v0, p0, Lcrr;->d:Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, v0}, Lcrr;->a(Landroid/hardware/camera2/params/MeteringRectangle;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcrr;->c:Linu;

    invoke-virtual {v0}, Landroid/hardware/camera2/params/MeteringRectangle;->getRect()Landroid/graphics/Rect;

    move-result-object v3

    iget-object v4, p0, Lcrr;->f:Landroid/graphics/Rect;
    ...
    :cond_2
    :try_start_4
    iget-object v3, p0, Lcrr;->b:Ljava/util/List;
...
.method private final a(Landroid/hardware/camera2/params/MeteringRectangle;)Z
    ...
    iget-object v2, p0, Lcrr;->d:Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcrr;->a(Linu;)V
