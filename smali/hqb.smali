...
# direct methods
.method constructor <init>(Lhmc;Lcom/google/android/gms/feedback/FeedbackOptions;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 2

    iput-object p2, p0, Lhqb;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iput-object p3, p0, Lhqb;->b:Landroid/os/Bundle;

    iput-wide p4, p0, Lhqb;->c:J

    iput-object p6, p0, Lhqb;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lhqd;-><init>(Lhmc;B)V
...
.method protected final a(Lhqf;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lhqb;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iget-object v1, p0, Lhqb;->b:Landroid/os/Bundle;

    iget-wide v2, p0, Lhqb;->c:J

    iget-object v4, p0, Lhqb;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Lhqc;

    invoke-direct {v5, p0}, Lhqc;-><init>(Lhqb;)V
    ...
    :goto_2
    invoke-interface {v5}, Lhps;->asBinder()Landroid/os/IBinder;
    ...
    .line 5
    invoke-virtual {p0, v0}, Lhqb;->c(Lcom/google/android/gms/common/api/Status;)V
