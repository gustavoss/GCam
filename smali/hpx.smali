...
# direct methods
.method constructor <init>(Lhmc;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 1
    ...
    iput-object p5, p0, Lhpx;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;
...
.method protected final a(Lhqf;)V
    ...
    :try_start_0
    iget-object v0, p0, Lhpx;->a:Landroid/os/Bundle;

    iget-wide v2, p0, Lhpx;->b:J

    iget-object v1, p0, Lhpx;->c:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v4, Lhpy;

    invoke-direct {v4, p0}, Lhpy;-><init>(Lhpx;)V
    ...
    :goto_1
    invoke-interface {v4}, Lhps;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Lhpx;->c(Lcom/google/android/gms/common/api/Status;)V
